  ...
  <div>
    <div className="jumbotron" id="featured_posts">
      <div className="container">
        <h1 className="display-3" id="blog_heading">
          Featured blog
        </h1>
        <p id="blog_content">
          ...
          <div className="card">
            <div className="card-body text-center">
              <img
                ...
                src="https://afs-calneva.org/wp-content/uploads/sites/8/2016/07/North_Fork_Amer_River_5July2008-003_size-edit.jpg"
                alt="Photo of sunset"
              />
              <br />
...
4.5 */}
          ...
          <div className="card">
            <div className="card-body text-center">
              ...
              <p>
                Put simply, all of these different types of paragraphs simply
                involve layering on a different purpose or intent. When students
                have the right foundation, it’s just that simple.
              </p>
            </div>
            <div className="card-footer">
              <i className="fa fa-star" aria-hidden="true" />
